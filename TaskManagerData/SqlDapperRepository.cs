...
namespace TaskManagerData
{
        ...
        where TEntity : class
    {
        ...
        private DapperRepository<TEntity> _internalRepository;

        public SqlDapperRepository(string webConfigConnectionStr)
        {
            _internalRepository = new DapperRepository<TEntity>(new SqlConnection(webConfigConnectionStr));
        }


        public SqlDapperRepository(IDbConnection connection)
        {
            _internalRepository = new DapperRepository<TEntity>(connection);
